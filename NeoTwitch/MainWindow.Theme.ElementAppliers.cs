...
public partial class MainWindow
{
    ...
    private void ApplyBorderTheme(Border border, ThemePalette palette)
    {
    ...
    private void ApplyTextBlockTheme(TextBlock textBlock, ThemePalette palette)
    {
    ...
    private void ApplyListBoxTheme(WpfListBox listBox, ThemePalette palette)
    {
